...
namespace Microsoft.BotBuilderSamples.Dialogs
{
    public class MainDialog : ComponentDialog
    {
        ...
        public MainDialog(Recognizer luisRecognizer, BookingDialog bookingDialog, NovoEmpregadoDialog novoEmpregadoDialog, ILogger<MainDialog> logger)
        ...
        private async Task<DialogTurnResult> IntroStepAsync(WaterfallStepContext stepContext, CancellationToken cancellationToken)
        {
            ...
            var messageText = stepContext.Options?.ToString() ?? "Olá, meu nome é Ravi, em que posso ajudar?";
        ...
        private async Task<DialogTurnResult> ActStepAsync(WaterfallStepContext stepContext, CancellationToken cancellationToken)
        {
            ...
            switch (luisResult.TopIntent().intent)
            {
                ...
                case Deserialize.Intent.GetWeather:
        ...
        private static async Task ShowWarningForUnsupportedCities(ITurnContext context, Deserialize luisResult, CancellationToken cancellationToken)
        {
